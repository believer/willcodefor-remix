export const GitHub = () => {
  return (
    <a
      className="flex items-center rounded bg-gray-100 p-2 text-gray-700 transition-colors hover:bg-github hover:text-white dark:bg-gray-700 dark:text-white"
...
export const Twitter = () => {
  return (
    <a
      className="flex items-center rounded bg-gray-100 p-2 text-gray-700 transition-colors hover:bg-twitter hover:text-white dark:bg-gray-700 dark:text-white"
...
export const Polywork = () => {
  return (
    <a
      className="flex items-center rounded bg-gray-100 p-2 transition-colors hover:bg-polywork hover:text-white dark:bg-gray-700"

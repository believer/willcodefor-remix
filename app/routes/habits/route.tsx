...
const habits: Habit[] = [
  {
    ...
    startDate: DateTime.fromISO('2023-03-12T17:26:32.000Z'),
    color:
      'bg-gradient-to-br from-emerald-500 to-emerald-700 ring-emerald-500/30',
    resets: [
      {
        startDate: DateTime.fromISO('2023-03-08T20:45:32.000Z'),
        endDate: DateTime.fromISO('2023-03-11T15:48:32.000Z'),
      },
      {
        startDate: DateTime.fromISO('2023-03-02T17:29:32.000Z'),
        endDate: DateTime.fromISO('2023-03-08T15:48:32.000Z'),
      },
      {

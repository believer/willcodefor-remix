export default function iteam() {
  return (
    <div className="markdown grid grid-cols-1 md:grid-cols-12">
      <div
        className="col-span-12
      md:col-start-3 md:col-end-13"
      >
        <h2>Energiföretagen</h2>
        <p className="text-sm text-gray-500">Full stack developer ~ 2019</p>
        <p>
          Complete rebuild of Energiföretagens publications website, EBR-e, on
          top of their existing Episerver.
        </p>
        <div className="mt-4 text-xs dark:text-gray-600">
        ...
        <p>
          ...
          and have helped them build multiple platforms including their website,
          app, API, forum, knowledge base and much more.
        </p>
        <div className="mt-4 text-xs dark:text-gray-600">
          React, React Native, Node, Docker, MongoDB, NodeBB, Flow, TypeScript
        </div>
        <h2>Playpilot</h2>
        <p className="text-sm text-gray-500">Backend developer ~ 2018</p>
        <p>
        ...
        <div className="mt-4 text-xs dark:text-gray-600">React, PWA</div>
        <h2>Kvalitetsbygg</h2>
        <p className="text-sm text-gray-500">
          Frontend developer ~ 2016 - 2017
        </p>
        ...
        <div className="mt-4 text-xs dark:text-gray-600">AngularJS, Mocha</div>
        ...
        <p className="text-sm text-gray-500">Frontend developer ~ 2016</p>
        ...
        <div className="mt-4 text-xs dark:text-gray-600">AngularJS, Node</div>
        <h2>Radical FM</h2>
        <p className="text-sm text-gray-500">
        ...
        <p>
          ...
          add your voice and stream to each other to make it more like your own
          radio station.
        </p>
        <div className="mt-4 text-xs dark:text-gray-600">
        ...
        <div className="mt-4 text-xs dark:text-gray-600">HTML, CSS, jQuery</div>
      </div>
    </div>
  )
}
